...
| 文档 | 说明 | 日期 | 状态 |
|------|------|------|------|
| [redigg-design.md](./redigg-design.md) | **产品设计文档** - 愿景、架构、技术实现 | 2026-03-07<br>v1.0.0 | ✅ 完成 |
| [contribution.md](./contribution.md) | **贡献指南** - 开发标准、代码规范、Git 流程 | 2026-03-07<br>v1.0.0 | ✅ 完成 |

### 规划文档

| 文档 | 说明 | 日期 | 状态 |
|------|------|------|------|
| [PRODUCT_ROADMAP.md](./PRODUCT_ROADMAP.md) | **产品路线图** - Phase 1-4 战略路线、优先级、里程碑 | 2026-03-08<br>v1.0.0 | 📅 规划中 |
| [ITERATION_PLAN.md](./ITERATION_PLAN.md) | **迭代计划** - 5 阶段详细迭代方案、技术债务、KPIs | 2026-03-08<br>v1.0.0 | 📅 规划中 |
| [SCHEDULED_TASKS.md](./SCHEDULED_TASKS.md) | **定时任务规划** - Cron 任务列表、实现方案、监控指标 | 2026-03-08<br>v1.0.0 | 📅 规划中 |

### 开发指南

| 文档 | 说明 | 日期 | 状态 |
|------|------|------|------|
| [QUICK_START_V2.md](./QUICK_START_V2.md) | **快速启动指南** - 2 小时完成向量搜索+Planner+ 反馈系统 | 2026-03-08<br>v1.0.0 | 📝 草稿 |
